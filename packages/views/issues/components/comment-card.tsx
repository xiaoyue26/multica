  ...
  return (
    <div className="py-3">
      <div className="flex items-center gap-2.5">
        ...
        {agentModel && (
          <span className="rounded-md bg-muted px-1.5 py-0.5 text-[10px] font-medium font-mono text-muted-foreground">
            {agentModel}
          </span>
        )}
        <Tooltip>
      ...
      <Collapsible open={open} onOpenChange={handleOpenChange}>
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-2.5">
            ...
            {agentModel && (
              <span className="shrink-0 rounded-md bg-muted px-1.5 py-0.5 text-[10px] font-medium font-mono text-muted-foreground">
                {agentModel}
              </span>
            )}
            <Tooltip>
